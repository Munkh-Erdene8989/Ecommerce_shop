...
export default function EditProductPage() {
  ...
  return (
    <div className="w-full max-w-2xl space-y-6">
      <h1 className="text-xl font-bold sm:text-2xl">Бүтээгдэхүүн засах</h1>
      <Card>
        <CardHeader>
        ...
        <div>
          ...
          <div className="mt-3">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-2">
              ...
              <Button type="button" variant="destructive" onClick={() => setDeleteDialogOpen(true)} className="w-full sm:w-auto">
                Устгах
              </Button>
            </div>
          </form>
